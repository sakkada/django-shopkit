...
from shopkit.product.forms import BaseVariantForm, registry
from . import models
...
@registry.register(models.Cardigan)
...
@registry.register(models.Jacket)
...
@registry.register(models.Shirt)
