...
import shopkit.product.models
from shopkit.contrib.product.category.models import CategorizedProductMixin
from shopkit.contrib.tax.flatgroups.models import TaxedProductMixin, TaxedVariantMixin
from shopkit.contrib.stock.singlestore.models import VariantStockLevelMixin
...
class Product(TaxedProductMixin,
              CategorizedProductMixin,
              shopkit.product.models.Product):
...
class Variant(TaxedVariantMixin, VariantStockLevelMixin,
              shopkit.product.models.Variant):
